  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <ScrollView contentContainerStyle={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.group}>
          ...
          <View style={styles.chipGrid}>
            {categories.map((cat) => {
              ...
              return (
                <Pressable key={cat.id} onPress={() => setCategory(cat.id)} style={[styles.chip, selected ? styles.chipSelected : {}]}>
                  <Ionicons color={selected ? Colors.text.inverse : Colors.text.secondary} name={cat.icon as any} size={16} />
        ...
        <Button disabled={!canSubmit} title="Save request" onPress={handleSubmit} />
